...
urlpatterns = [
    ...
    path("check_company_details/<str:business_uuid>", views.CheckCompanyDetailsView.as_view(), name="check_company_details"),
    path("manual_companies_house_input", views.ManualCompaniesHouseInputView.as_view(), name="manual_companies_house_input"),
    path("add_a_business/<str:location>", views.AddABusinessView.as_view(), name="add_a_business"),
    ...
    path("add_a_recipient/<str:location>", views.AddARecipientView.as_view(), name="add_a_recipient"),
