# Generated by Django 4.2.15 on 2024-08-29 08:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ground",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="apply_for_a_licence.ground"
                    ),
                ),
                (
                    "services",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to="apply_for_a_licence.services"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to="apply_for_a_licence.useremailverification"
            ),
        ),
        migrations.CreateModel(
            name="Organisation",
            fields=[
                ...
                (
                    ...
                    models.CharField(choices=[("yes", "Yes"), ("no", "No")], max_length=3, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.OneToOneField(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="apply_for_a_licence.status"
                    ),
                ),
                ("licence", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to="apply_for_a_licence.licence")),
            ],
            options={
                "abstract": False,
            },
