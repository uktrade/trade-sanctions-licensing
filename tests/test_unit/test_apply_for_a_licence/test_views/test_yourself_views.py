...
class TestYourselfAndIndividualAddedView:
    def test_do_not_add_another_individual_successful_post(self, authenticated_al_client, yourself_licence, yourself):
        response = authenticated_al_client.post(
            reverse("yourself_and_individual_added", kwargs={"licence_pk": yourself_licence.id}),
    ...
    def test_add_another_individual_successful_post(self, authenticated_al_client, yourself_licence, yourself):
        response = authenticated_al_client.post(
            reverse("yourself_and_individual_added", kwargs={"licence_pk": yourself_licence.id}),
    ...
    def test_no_yourself_or_individual_redirects(self, authenticated_al_client_with_licence, yourself_licence):
...
class TestAddYourselfView:
    def test_successful_post(self, authenticated_al_client, yourself_licence, yourself):
        response = authenticated_al_client.post(
            reverse("add_yourself", kwargs={"licence_pk": yourself_licence.id}) + f"?yourself_id={yourself.id}",
            data={
                "first_name": "John",
                "last_name": "Doe",
        ...
        assert (
            reverse(
                ...
                kwargs={"licence_pk": yourself_licence.id, "location": "in-uk", "yourself_id": yourself.id},
            )
    ...
    def test_is_applicant(self, authenticated_al_client_with_licence, yourself_licence, yourself):
    ...
    def test_create_new_individual_successful_get(self, authenticated_al_client, yourself_licence):
        authenticated_al_client.get(
            reverse("add_yourself", kwargs={"licence_pk": yourself_licence.id}) + "?new=yes",
        )
...
class TestAddYourselfAddressView:
    def test_successful_non_uk_address_post(self, authenticated_al_client, yourself_licence, yourself):
        response = authenticated_al_client.post(
            reverse(
                "add_yourself_address",
                kwargs={"licence_pk": yourself_licence.id, "location": "outside-uk", "yourself_id": yourself.id},
            ),
            data={
                "country": "DE",
                "town_or_city": "Berlin",
        ...
        assert response.url == reverse("yourself_and_individual_added", kwargs={"licence_pk": yourself_licence.id})
        yourself = Individual.objects.get(id=yourself.id)
...
class TestDeleteIndividualFromYourselfView:
    def test_successful_post(self, authenticated_al_client, yourself_licence, yourself):
        ...
        response = authenticated_al_client.post(
            reverse(
                "delete_individual_from_yourself", kwargs={"licence_pk": yourself_licence.id, "individual_id": individual1.id}
            ),
        )
        individuals = Individual.objects.filter(licence=yourself_licence)
    ...
    def test_delete_all_individuals_post(self, authenticated_al_client, yourself_licence, yourself):
        ...
        response = authenticated_al_client.post(
            reverse(
                "delete_individual_from_yourself", kwargs={"licence_pk": yourself_licence.id, "individual_id": individual2.id}
            ),
        )
        individuals = Individual.objects.filter(licence=yourself_licence)
        assert individual1 not in individuals
    ...
    def test_unsuccessful_post(self, authenticated_al_client, yourself_licence, yourself):
        ...
        response = authenticated_al_client.post(
            reverse(
                "delete_individual_from_yourself", kwargs={"licence_pk": yourself_licence.id, "individual_id": individual3.id}
            ),
        )
